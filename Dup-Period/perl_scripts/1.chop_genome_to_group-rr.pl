open GENOME, "</mnt/san1/usr/thw/info/neurospora/neurospora_crassa_or74a_12_supercontigs.fasta" or die "can not open genome file";
...
open ARRAY, "<p01-array-g6.txt" or die "Can not open array file\.\n";
while (<ARRAY>) { chomp;
